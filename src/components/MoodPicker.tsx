...
const MoodPicker: FC<MoodPickerProps> = ({
  ...
  return (
    <div
      className="group/mood relative w-full max-w-md"
    ...
    >
      <button
        ...
        className="flex w-full items-center gap-4 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 text-left shadow-inner transition-all duration-300 hover:border-teal-200 hover:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:cursor-default disabled:hover:border-slate-200/80 disabled:hover:bg-slate-50/80 sm:p-5"
      >
        <span className="flex h-20 w-20 shrink-0 items-center justify-center rounded-[1.5rem] border border-white bg-white text-center shadow-sm sm:h-24 sm:w-24">
          {selectedMood ? (
            <span
            ...
            <span className="text-5xl leading-none text-slate-200 sm:text-6xl">?</span>
          )}
        </span>
